...
https://xiaoxiami.gitbook.io/big-data/hadoop/an-zhuang
...
文件    1    311585484    hdfs://localhost:8020/hadoop-2.6.0-cdh5.7.0.tar.gz
文件夹    0    0    hdfs://localhost:8020/hdfsapi
文件    1    49    hdfs://localhost:8020/hello.txt
