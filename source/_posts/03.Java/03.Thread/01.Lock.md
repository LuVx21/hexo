...
具体的一个场景就是在一个同步域内调用本类的其他由`synchronized`修饰的方法或代码块时,是永远可以得到锁的
...
而ReentrantReadWriteLock则通过创建2个实现了Lock接口的内部类`ReadLock`,`WriteLock`来维护一对锁,实现性能的提升.
...
![](https://raw.githubusercontent.com/LuVx21/doc/master/source/_posts/99.img/obj_head.png)
...
![](https://raw.githubusercontent.com/LuVx21/doc/master/source/_posts/99.img/偏向锁.png)

![](https://raw.githubusercontent.com/LuVx21/doc/master/source/_posts/99.img/轻量级锁.png)
